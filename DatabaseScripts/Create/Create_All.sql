...
CREATE TABLE JWT_AUDIT (
  JWT_AUDIT_ID NUMBER NOT NULL, JWT_TOKEN VARCHAR2(256) ,
  LOGGED_IN_TIME DATE DEFAULT sysdate NOT NULL, 
  CONSTRAINT JWT_AUDIT_PK PRIMARY KEY (JWT_AUDIT_ID ));

CREATE TABLE JWT_HEADERS (JWT_AUDIT_ID NUMBER NOT NULL , HEADER_NAME VARCHAR2(20) 
, HEADER_VALUE VARCHAR2(256) NOT NULL , ID NUMBER NOT NULL 
, CONSTRAINT JWT_HEADERS_PK PRIMARY KEY (ID ));

CREATE SEQUENCE JWT_AUDIT_SEQUENCE  START WITH 1500 INCREMENT BY 1;
CREATE SEQUENCE JWT_HEADERS_SEQUENCE  START WITH 3000 INCREMENT BY 1;  

INSERT INTO SECURITY_SETTINGS (ID, KEY, VALUE) VALUES ('1', 'jwt.expiration.in.minutes', '5');
...
INSERT INTO USERS (ID, USERNAME, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES (5, 'configuration', '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'configuration', 'configuration', 'rules@user.com', 1, sysdate);
INSERT INTO USERS (ID, USERNAME, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES (6, 'grid', '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'grid', 'grid', 'grid@user.com', 1, sysdate);
INSERT INTO USERS (ID, USERNAME, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES (7, 'disabled', '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'user', 'user', 'disabled@user.com', 0, sysdate);
INSERT INTO USERS (ID, USERNAME, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES (8, 'card', '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'card', 'card', 'card@user.com', 1, sysdate);


INSERT INTO AUTHORITY (ID, NAME) VALUES (1, 'ROLE_ALERTS');
INSERT INTO AUTHORITY (ID, NAME) VALUES (2, 'ROLE_RULES');
INSERT INTO AUTHORITY (ID, NAME) VALUES (3, 'ROLE_CONFIGURATION');
INSERT INTO AUTHORITY (ID, NAME) VALUES (4, 'ROLE_USERS');
INSERT INTO AUTHORITY (ID, NAME) VALUES (5, 'ROLE_CARD_TRANSACTIONS');
INSERT INTO AUTHORITY (ID, NAME) VALUES (6, 'ROLE_GRID');
...
(
  ...
  CONSTRAINT CONFIGURATION_ID_PK PRIMARY KEY (CONFIGURATION_ID )
);
...
Insert into CONFIGURATION_PARAMETERS (CONFIGURATION_ID, KEY,VALUE) values (1,'COMMIT_SIZE','5');
Insert into CONFIGURATION_PARAMETERS (CONFIGURATION_ID, KEY,VALUE) values (2,'SKIP_LIMIT','100');
Insert into CONFIGURATION_PARAMETERS (CONFIGURATION_ID,KEY,VALUE) values (3,'LANDING_DIRECTORY','/home/batchconfig/batch/landing');
Insert into CONFIGURATION_PARAMETERS (CONFIGURATION_ID,KEY,VALUE) values (4,'SUCCESS_DIRECTORY','/home/batchconfig/batch/success');
Insert into CONFIGURATION_PARAMETERS (CONFIGURATION_ID,KEY,VALUE) values (5,'ERROR_DIRECTORY','/home/batchconfig/batch/errors');
Insert into CONFIGURATION_PARAMETERS (CONFIGURATION_ID,KEY,VALUE) values (6,'PROCESSING_DIRECTORY','/home/batchconfig/batch/processing');
Insert into CONFIGURATION_PARAMETERS (CONFIGURATION_ID,KEY,VALUE) values (7, 'SKIPPED_ITEMS_DIRECTORY','/home/batchconfig/batch/skipped');
Insert into CONFIGURATION_PARAMETERS (CONFIGURATION_ID,KEY,VALUE) values (8, 'DB_Release','4.3');
commit;
