...
$(function () {
    ...
    $("#ebankingAlertsServiceBtn").click(function () {
        $.ajax({
            url: "http://localhost:8090/alerts/protectedebankingalerts",
            type: "GET",
            contentType: "application/json; charset=utf-8",
            headers: createAuthorizationTokenHeader(),
            success: function (data, textStatus, jqXHR) {
    ...
    $("#cardAlertsServiceBtn").click(function () {
        $.ajax({
            url: "http://localhost:8090/alerts/protectedcardalerts",
            type: "GET",
            contentType: "application/json; charset=utf-8",
            headers: createAuthorizationTokenHeader(),
            success: function (data, textStatus, jqXHR) {
    ...
    $("#depositsAlertsServiceBtn").click(function () {
        $.ajax({
            url: "http://localhost:8090/alerts/protecteddepositalerts",
            type: "GET",
            contentType: "application/json; charset=utf-8",
            headers: createAuthorizationTokenHeader(),
            success: function (data, textStatus, jqXHR) {
    ...
    $("#ordersAlertsServiceBtn").click(function () {
        $.ajax({
            url: "http://localhost:8090/alerts/protectedorderalerts",
            type: "GET",
            contentType: "application/json; charset=utf-8",
            headers: createAuthorizationTokenHeader(),
            success: function (data, textStatus, jqXHR) {
    ...
    $("#rulesServiceBtn").click(function () {
        $.ajax({
            url: "http://localhost:8090/protectedrules",
            type: "GET",
            contentType: "application/json; charset=utf-8",
            headers: createAuthorizationTokenHeader(),
            success: function (data, textStatus, jqXHR) {
    ...
    $("#configurationServiceBtn").click(function () {
        $.ajax({
            url: "http://localhost:8090/protectedconfiguration",
            type: "GET",
            contentType: "application/json; charset=utf-8",
            headers: createAuthorizationTokenHeader(),
            success: function (data, textStatus, jqXHR) {
    ...
    $("#usersServiceBtn").click(function () {
        $.ajax({
            url: "http://localhost:8090/protectedusers",
            type: "GET",
            contentType: "application/json; charset=utf-8",
            headers: createAuthorizationTokenHeader(),
            success: function (data, textStatus, jqXHR) {
    ...
    $("#cardTransactionsServiceBtn").click(function () {
        $.ajax({
            url: "http://localhost:8090/protectedcardtransactions",
            type: "GET",
            contentType: "application/json; charset=utf-8",
            headers: createAuthorizationTokenHeader(),
            success: function (data, textStatus, jqXHR) {
    ...
    $("#gridServiceBtn").click(function () {
        $.ajax({
            url: "http://localhost:8090/protectedgrid",
            type: "GET",
            contentType: "application/json; charset=utf-8",
            headers: createAuthorizationTokenHeader(),
            success: function (data, textStatus, jqXHR) {
